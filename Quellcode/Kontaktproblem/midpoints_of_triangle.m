...
%MIDPOINTS_OF_TRIANGLE evaluates the midpoints of the edges of the triangle 
%T. The first and second row stores the x- and y-values of the midpoints and 
%the third and fourth row stores the indices of the nodes, that are the 
%start and end of the edge. The matrix mid_triangle restores the indices of 
%the midpoints in the rows of every triangle by the columns (by positive 
