...
%shape functions, which are needed for the quadrature. The matrix points 
%stores the x-,y-values of the nodes of the triangle, ansatz_fun a vector 
%of shape functions and num_of_nodes the number of nodes for the quadrature 
%formula.
