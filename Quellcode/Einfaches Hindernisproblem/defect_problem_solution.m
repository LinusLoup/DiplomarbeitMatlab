...
%DEFECT_PROBLEM_SOLUTION evaluates the solution of the local defect problem
%(2.9), given the nodes, triangles, triangle-midpoints-ordering, the 
%functionvalues of the Galerkin solution u_S at the midpoints and the same 
%for the solution.
