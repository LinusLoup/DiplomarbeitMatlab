...
%ASSEMBLE evaluates the global matrix A and load vector f out of the given 
%nodes, triangles, loadfunction, number of nodes and the Galerkin 
%approximation u_S.
...
for i = 1:nt
    ...
    % Evaluating the local vector fl: (here is Gauss-quadrature over 
    % triangles used)
