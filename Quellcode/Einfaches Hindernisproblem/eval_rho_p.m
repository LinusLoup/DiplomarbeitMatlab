...
%midpoints-triangle-ordering (midtri). Also it is given the solution of 
%the local defect problem eps_V and the function fun, which is part of the
%integral in rho_S. u_S are, as always, the Galerkin solution.
...
for k = 1:np
    ...
    % Evaluation of the line integral over the edges E\in E_p:
        ...
        for i = 1:length(E_p)    
            ...
            % affin transformation of the local integral on the global edge
            % by multiplication of the jacobian:
