...
%EDGE_NEIGHBOURHOOD computes the indices of the triangles, which are the 
%neighbours for the given edges or point. The vector flag shows, if an edge 
%has got only one neighbour (flag = 0) or two (flag = 1).
