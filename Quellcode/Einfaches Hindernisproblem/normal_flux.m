...
%NORMAL_FLUX computes the normal flux for all given edges E in E_p. The 
%other given objects are: The nodes of the triangulation, the indices of 
%the triangles-nodes ordering, the midpoints/edges-matrix edges, the 
%edges-triangle-ordering edge_triangle and the functionvalues of the 
%Galerkin solution uS_values.
