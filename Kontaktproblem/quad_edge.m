...
%QUAD_EDGE computes the weights, Gauss-points and functionvalues of the shape functions, which are needed for the quadrature over an edge of a triangle. The matrix points stores the x-,y-values of the nodes of the edge, ansatz_fun a vector of shape functions and num_of_nodes the number of nodes for the quadrature formula.
...
switch num_of_nodes
    ...
    case 4
        ...
        local_poi = [-sqrt(3/7+2/7*sqrt(6/5)),-sqrt(3/7-2/7*sqrt(6/5)), sqrt(3/7-2/7*sqrt(6/5)),sqrt(3/7+2/7*sqrt(6/5))];
            
    case 5
        wi = [(322-13*sqrt(70))/900,(322+13*sqrt(70))/900,128/225, (322+13*sqrt(70))/900,(322-13*sqrt(70))/900];
        local_poi = [-1/3*sqrt(5+2*sqrt(10/7)),-1/3*sqrt(5-2*sqrt(10/7)), 0,1/3*sqrt(5-2*sqrt(10/7)),1/3*sqrt(5+2*sqrt(10/7))];
