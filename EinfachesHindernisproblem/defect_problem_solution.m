function [eps_V_exact,rho_E,d_E,a_phi] = defect_problem_solution(points,triangle,mid_triangle,rho_s,u_S_mid, z_obs_midpoints)
%DEFECT_PROBLEM_SOLUTION evaluates the solution of the local defect problem (2.9), given the nodes, triangles, triangle-midpoints-ordering, the functionvalues of the Galerkin solution u_S at the midpoints and the same for the solution.
...
% evaluation of the value a(phi_E,phi_E) to determine the norm of phi_E:
for i = 1 : nmp
...
% evaluating the values of (2.11) and at least (2.10):
a_phi = a_phi.^(1/2);
rho_E = rho_s./a_phi;
