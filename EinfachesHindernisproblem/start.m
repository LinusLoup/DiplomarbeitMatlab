...
h = 2;
[p,e,t] = initmesh(data.mysquareg,'Hmax',h);    %square: [-1,1]^2
...
tic
% adaptive algorithm:
[u_S,p,e,t,midtri,midpoints,rhoS_plot,IQ_plot,J_error,osc_term, recursion_depth] = adaptive_refinement_solution(p,e,t,u_S,fun, data,J_u,eps,theta_rho,theta_osc,nmax,itermax);
toc
